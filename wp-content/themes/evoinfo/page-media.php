        ...
        <div class="site_wrapper indent_content">
         ...
         <div class="fix col_2 mb40">
             ...
             <div class="left_area sp_mb15">
                 ...
                 <p class="seminar_btn t_right"><a href="/media/mirakuu" class="f_green">MORE
                         →</a></p>
             </div>
         ...
         <div class="fix col_2 mb80">
             <div class="right_area sp_mb15">
                 ...
                 <p class="seminar_btn t_right"><a href="/media/mirakuu#premium" class="f_green">MORE→</a></p>
             </div>
             <div class="left_area">
         ...
         <div class="fix col_2 mb80">
             <div class="right_area sp_mb15">
                 ...
                 <p class="seminar_btn t_right"><a href="/media/ehondanshi" class="f_green">MORE→</a></p>
             </div>
             <div class="left_area">
